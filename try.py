...
texts=['he likes apple',
                      'he really likes apple',
                      'he hates apple',
                      'he really hates apple']

with open("D:/github/Sentiment-analysis/modelsques2_result.txt", "w") as fw:
    for line in texts:
        fw.write(" ".join(jieba.lcut(line)) + "\n")
sents = doc2vec.TaggedLineDocument("D:/github/Sentiment-analysis/modelsques2_result.txt")
